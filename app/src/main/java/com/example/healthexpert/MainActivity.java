    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.appoinment:
                Toast.makeText(getApplicationContext(),"Opening Doctor's Appointment", Toast.LENGTH_SHORT).show();
                Intent appointment = new Intent(MainActivity.this, AppoinmentActivity.class);
