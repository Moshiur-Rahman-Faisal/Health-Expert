        ...
        mCalculateBMI.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (typeofuser.equals("0")){
                    ...
                    Intent bmiresult = new Intent(BMI.this, BMIResult.class);

                    bmiresult.putExtra("gender", typeofuser);
                    bmiresult.putExtra("height", mintprogress);
                    bmiresult.putExtra("weight", weight2);
                    bmiresult.putExtra("age", age2);
